...
app.config(function($mdThemingProvider,$interpolateProvider,$httpProvider,$compileProvider,$locationProvider){$mdThemingProvider.theme("default").accentPalette("blue");$mdThemingProvider.enableBrowserColor({theme:"default",palette:"background",hue:"50"});$interpolateProvider.startSymbol("{*");$interpolateProvider.endSymbol("*}");$httpProvider.useApplyAsync(true);$compileProvider.debugInfoEnabled(false);$compileProvider.cssClassDirectivesEnabled(false);$compileProvider.commentDirectivesEnabled(false);
