...
b(window.open("https://goo.gl/zajpYF","_blank"),2E3);break;case "navigate":d("Transporting!");b(a.transport(c.parameters.page),2E3);break;default:d(c.fulfillment.speech)}};a.transport=function(a){if(-1!=="blog about portfolio contact certificates home".split(" ").indexOf(a)){var b="/"+a+"/";"home"===a&&(b="/");pjax.invoke(b,"main")}else d("Sorry, the page does not exist")}}]);
