...
app.controller("main",["$scope","$interval","$window","Toast","$sce","Dialog",function(a,d,b,c,e,f){a.gridLay=!0;localStorage.getItem("theme")?(a.isDark=!0,a.theme={bg:"grey-800",footer:"grey-700"}):(a.isDark=!1,a.theme={bg:"grey-A100",footer:"grey-A100"});a.setDark=function(b){(a.isDark=b)?(localStorage.setItem("theme","dark"),c("Dark theme activated","refresh")):(localStorage.removeItem("theme"),c("Light theme activated","refresh"))};a.counter=0;a.adjective="A Web Developer;A Programmer;Google Play Rising Star;Loves OpenSource;A Linux Admin;Elon Musk Fan;Philomath;Tech Enthusiast".split(";");
d(function(){7>a.counter?a.counter++:a.counter=0},5E3);b.addEventListener("offline",function(){c("You're Offline. Serving from cache!",!1);b.addEventListener("online",function(a){c("You're Online now !","ok")},{once:!0,capture:!1})},!1);a.trust=function(a){e.trustAsUrl(a)};a.show=function(b){1==a.gridLay&&(a.gridLay=!1,navigator.onLine||c("You're offline. Serving from cache!"))};a.showDlg=function(a){f.show("feedback",a)};a.go=function(a){b.location.href=e.trustAsResourceUrl(a)}}]);
