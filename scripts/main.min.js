...
app.controller("share",function($scope,Dialog,Toast){$scope.link=window.location.href;$scope.title=angular.element(window.document)[0].title;$scope.openShare=function(ev){Dialog.show("share",ev)};$scope.closeShare=function(){Dialog.close()}});app.controller("ProjectCtrl",function(Panel){this.show=function(dest){Panel(dest)}});
